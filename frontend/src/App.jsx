      ...
      <div className='flex flex-1 overflow-hidden relative'>
        ...
        <main className='flex-1 overflow-y-auto relative'>
          ...
          <header className='bg-white dark:bg-surface-dark border-b border-slate-200 dark:border-surface-border px-6 py-3 flex items-center gap-6 sticky top-0 z-40 shadow-sm'>
            <div className='font-black text-2xl italic tracking-tighter text-slate-900 dark:text-white'>
              FedEx <span className='text-fedex-orange'>SMART</span>
            </div>
            <nav className='flex items-center gap-1'>
              ...
              <NavItem
                to='/agents'
                label={activeRole === ROLES.FEDEX_ADMIN ? 'Agencies' : 'Agents'}
              ...
              {activeRole === ROLES.FEDEX_ADMIN && (
                <>
                  ...
                  <NavItem
                    to='/sla-monitor'
                    label='SLA Monitor'
                    active={location.pathname === '/sla-monitor'}
                    badge='Live'
                  />
                  <NavItem
                    to='/sop-compliance'
                    label='SOP Compliance'
                    active={location.pathname === '/sop-compliance'}
                  />
                  <NavItem
                    to='/audit-logs'
                    label='Audit Logs'
        ...
        <LanguageProvider>
          <BrowserRouter>
            <Routes>
              ...
              <Route
                path='*'
                element={<AppContent user={user} onLogout={handleLogout} />}
              />
            </Routes>
